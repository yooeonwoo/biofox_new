          ...
          {formData.consentReceived && (
            <div className="space-y-3 p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              {formData.consentImageUrl ? (
                ...
                <div 
                  className="border-2 border-dashed border-green-300 rounded-lg p-6 text-center cursor-pointer hover:bg-green-100 transition-colors"
                  onClick={() => consentFileInput?.click()}
                >
                  <div className="space-y-2">
