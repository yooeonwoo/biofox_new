...
import { useAdminShopDetail, useShopAllocations } from "@/lib/hooks/adminShopDetail";
      ...
      <SheetContent side="right" className="w-[480px] sm:w-[540px] overflow-y-auto">
        {isShopLoading ? (
          ...
          <div className="space-y-4 p-2">
            {/* 상단 카드 */}
            <div className="rounded-md border p-4 bg-white shadow-sm space-y-2">
