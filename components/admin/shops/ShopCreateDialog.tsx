...
import { useCreateShop } from "@/lib/hooks/shops";
...
export default function ShopCreateDialog() {
  const form = useForm<FormValues>({ resolver: zodResolver(schema), defaultValues: { kolId: undefined as unknown as number, ownerName: "", shopName: "", region: "", contractDate: "" } });
      ...
      <DialogContent className="sm:max-w-md">
        ...
        >
          <div className="grid grid-cols-4 items-center gap-2">
            ...
            <Input type="number" className="col-span-3" {...form.register("kolId", { valueAsNumber: true })} />
          </div>
          <div className="grid grid-cols-4 items-center gap-2">
